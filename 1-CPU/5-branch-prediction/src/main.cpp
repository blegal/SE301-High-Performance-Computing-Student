...
#include "vec_sum/vec_sum_cond.hpp"
#include <cstring>
#include <chrono>
#include <random>
...
void header( )
{
    ...
    printf("(II) Stage 5 - Branch predictions, remove “if” from your codes ! on MacOS\n");
#elif defined (__linux__)    
    printf("(II) Stage 5 - Branch predictions, remove “if” from your codes ! on Linux\n");
#else
    printf("(II) Stage 5 - Branch predictions, remove “if” from your codes ! on Windows\n");
#endif
...
int main(int argc, char* argv[])
{
    ...
    */
    ...
    printf("(II)\n");
    printf("(II) Evaluation of branch predictor - function 1 - data set 1\n");
    printf("(II)\n");
    ...
    for(int buffSize = v_begin; buffSize <= v_end; buffSize *= v_step)
    {
        ...
        for(int32_t loop = 0; loop < nTest; loop += 1)
            accu += vec_sum_cond(a_tab, buffSize);
    ...
    */
    ...
    printf("(II)\n");
    printf("(II) Evaluation of branch predictor - function 1 - data set 2\n");
    printf("(II)\n");
    ...
    for(int buffSize = v_begin; buffSize <= v_end; buffSize *= v_step)
    {
        ...
        for (int i = 0; i < buffSize; i += 1)
        {
          a_tab[i] = ((float)(rand()%256)) / 256.0f - 0.02;
        }
    ...
    */
    ...
    printf("(II)\n");
    printf("(II) Evaluation of branch predictor - function 2 - data set 1\n");
    printf("(II)\n");
    ...
    for(int buffSize = v_begin; buffSize <= v_end; buffSize *= v_step)
    {
        ...
        auto start_i_ref = std::chrono::system_clock::now();
        for(int32_t loop = 0; loop < nTest; loop += 1)
            accu += vec_sum_cond_hard(a_tab, buffSize);
        auto stop_i_ref = std::chrono::system_clock::now();
    ...
    */
    ...
    printf("(II)\n");
    printf("(II) Evaluation of branch predictor - function 2 - data set 2\n");
    printf("(II)\n");
    ...
    */
    ...
    printf("(II)\n");
    printf("(II) Evaluation of branch predictor - function 2 - data set 3\n");
    printf("(II)\n");
